...
export default function KitchenBillEmptyState({ embedded }) {
  return (
    <div
      className={`flex flex-col items-center justify-center px-6 text-center font-sans ${
        embedded ? "relative min-h-[50vh] bg-gradient-to-b from-zinc-50/90 via-white to-zinc-50/50 pb-8" : "py-16"
      }`}
    >
      {embedded && (
      <div
