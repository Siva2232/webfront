...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Parties", icon: Users, path: "accounting/parties" },
      { name: "Chart of Accounts", icon: BookOpen, path: "accounting/accounts" },
      { name: "Sales Orders", icon: TrendingUp, path: "accounting/orders" },
      { name: "Purchases", icon: TrendingDown, path: "accounting/purchases" },
      { name: "Expenses", icon: Receipt, path: "accounting/expenses" },
      { name: "Loans & Advances", icon: ArrowLeftRight, path: "accounting/loans" },
      { name: "Payments", icon: DollarSign, path: "accounting/payments" },
      { name: "Ledger", icon: FileText, path: "accounting/ledger" },
