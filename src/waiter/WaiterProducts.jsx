          ...
          <div className="flex gap-2 relative">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl bg-slate-100 border-none text-sm font-semibold focus:ring-2 focus:ring-orange-500/20 transition-all outline-none"
              />
              ...
              <div className="flex flex-wrap gap-2 max-w-7xl mx-auto">
                {categories.map((cat, idx) => (
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-slate-50 border border-slate-100/50 text-xs font-black uppercase hover:bg-orange-500 hover:text-white transition-all whitespace-nowrap"
                  >
                    {cat.name || cat}
                  </button>
                ))}
...
// Ensure you import ReceiptText for the button
import { ReceiptText, Trash2, Plus, Minus } from "lucide-react";
