...
export default function WaiterOrderSummary() {
  ...
  const currentOrders = useMemo(() => {
    // Create a local reference to aid debugging and ensure we use the latest state
    ...
    return allOrders.filter(o => {
      ...
      // Extended list of active statuses
      ...
      <nav className="sticky top-0 z-[60] bg-white border-b border-slate-100 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-[10px] font-black uppercase tracking-widest text-orange-500">Active Bill</h1>
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 pt-8 pb-32">
        {currentOrders.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm px-10">
            ...
            <button 
                onClick={() => navigate(`/waiter/products?table=${tableId}`)}
              ...
              <div key={order._id || idx} className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden mb-4">
                <div className="p-6 border-b border-slate-50">
                    ...
                    <div className="space-y-3">
                        {((order.items || order.orderItems || order.order_items) || []).map((item, i) => (
                ...
                <div className="p-6 bg-slate-50/30 flex justify-between items-center">
                    <div className="flex gap-4">
                        ...
                        {order.notes && (
                            <div className="p-3 bg-white rounded-2xl border border-slate-100 shadow-sm group">
       ...
       {/* Floating Action for adding more items */}
       {currentOrders.length > 0 && (
